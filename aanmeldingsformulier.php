...
<head>
 ...
 <?php 
  ...
  $sql = "SELECT ". dateFormat('l d F', 'date'). "as nl_date, id FROM events ORDER BY date, id";
   ...
   <center>
	...
	<div id="header">
      ...
      <div id="guts" class="index">
        ...
        <div>Vul het formulier helemaal in, zodra dit is gebeurt verschijnt er onderin het scherm een verstuurknop.</div>
        <form method="post" action="Add_piet.php" id="piet" onsubmit="validate_piet();">
		 ...
		 <br />
          <p>Heb je beschikking over eigen pak?
          <input type="radio" name="own_suit" value="0" checked/> Nee 
          <input type="radio" name="own_suit" value="1" /> Ja <br /></p>
		<br />
		  Op welke data wil je mee? <br />
		 (houd er rekening mee dat je op alle aangevinkte dagen ingedeeld kunt worden)<br />
          <?php
            $done = array();
          ...
          <?php } } ?>	
		  <br />
		  <p>Zou je willen helpen schminken op deze dagen?
          <input type="radio" name="size" value="0" checked/> Nee 
          <input type="radio" name="size" value="1" /> Ja <br /></p>
		  <br />	
          ...
          In welke groep was je ingedeeld tijdens de intocht in Haarlem afgelopen jaar?
          <select name="spot" class="styled-select">
          <option value="Ik heb niet meegedaan" selected> Ik heb niet meegedaan </option>
          <option value="Skatepieten"> Skatepieten </option>
          <option value="Fietspieten"> Fietspieten </option>
		  <option value="Typetjespiet"> Typetjespiet </option>
		  <option value="Band"> Band </option>
		  <option value="podium"> Podium </option>
		  <option value="Pepernootpiet"> Pepernootpiet </option>
          </select><br />
		 
		  Ben je afgelopen jaar mee geweest op de boot tijdens de intocht in Haarlem?
		  <select name="boot" class="styled-select">
		  <option value="Ik heb niet meegedaan" selected> Ik heb niet meegedaan </option>
          ...
          <input type="text" class="input" name="skill"><br />
