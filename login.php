	...
	<div id="header">
      ...
      <div class="title">
        Login:
			...
			<form action="login_check.php" method="post" onsubmit="return validate_login()" id="login">
			<input type="text" name="name" class="input" placeholder="Naam"/><br /><br />
			<input type="password" name="pass" class="input" placeholder="Wachtwoord"/><br/><br />
			<div class="button_right"><input class="submit" type="submit" value="Inloggen"/></div><br />
			</form><br />
			<?php
