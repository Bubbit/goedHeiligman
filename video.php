        ...
        <section id="main-content">
          <div id="guts" class="index">
            ...
            <?php if($pagenum == 1) { } else {?>
              <a href="video.php?pagenum=1"> eerste</a>
              <?php $prev = $pagenum - 1; ?>
              <a href="video.php?pagenum=<?php echo $prev; ?>"> vorige</a> 
            <?php } ?>
            ...
            <?php if($pagenum == $last) { } else { ?>
              <?php $next = $pagenum + 1; ?>
              <a href="video.php?pagenum=<?php echo $next; ?>"> volgende</a> 
              <a href="video.php?pagenum=<?php echo $last; ?>"> laatste </a>
            <?php } ?> 
            <div class="video_block">
              <?php while($pic_info = mysql_fetch_array($pic)) { ?>
                <div class="clip">
                  <iframe width="560" height="315" src="<?php echo $pic_info['name']; ?>" frameborder="0" allowfullscreen></iframe>
                </div>
              <?php
              }
              ?>
