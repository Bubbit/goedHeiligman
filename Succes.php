   ...
   <center>
	...
	<div id="header">
        ...
        <div id="guts" class="index">
          <p>Het aanmelden is gelukt.</p>
		  <p>Halverwege oktober zul je meer informatie ontvangen over de optredens.</p>
		  <p>Mocht je eind oktober nog niets hebben ontvangen neem dan contact met ons op via het contactformulier.</p>
        </div>
        </section>	
      </div>
