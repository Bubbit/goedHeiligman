...
<head>
 ...
 <?php 
  ...
  $sql = "SELECT * FROM static WHERE id = '4'";
  ...
  <center>
	...
	<div id="header">
        ...
        <div id="guts" class="index">
			<p>De aanmeldperiode is op 1 oktober gesloten.</p>
			<p>Door de vele aanmeldingen zitten we op alle dagen vol.</p>
			<p>Voor vragen omtrent de aanmeldingen, neem contact met ons op via ons contactformulier op deze website</p>
			<p>of mail naar stichtingdegoedheiligman@gmail.com.</p>
        </div>
		</section>	
      </div>
